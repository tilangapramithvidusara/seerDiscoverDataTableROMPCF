...
export class seerDiscoverDataTableROMPCF implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    {   
        ...
        // localStorage.setItem("accountId", ("91855757-e8d6-ee11-904d-000d3a0bca56" || "5172763a-52b1-ee11-a569-000d3a0bcfb2" || "22506193-8fbe-ee11-9079-002248015232" || accountId || ''));
