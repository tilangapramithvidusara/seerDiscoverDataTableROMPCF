...
export const fetchInitialDataAsync = async() => {
  try {    
    ...
    const requestBody = {
      "accountid": queryParameters?.get("accountId") || "5172763a-52b1-ee11-a569-000d3a0bcfb2" || "77c96e64-e3b6-ee11-a568-6045bdd2c9ae" || "3c278286-8c5e-ed11-9562-002248428304" || "5172763a-52b1-ee11-a569-000d3a0bcfb2" ||'b8357ad8-a499-ee11-be37-000d3a0be042',
